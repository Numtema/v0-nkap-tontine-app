        ...
        <Card className="rounded-3xl p-6 shadow-lg">
          <div className="flex items-center gap-4">
            <div className="relative">
              <Avatar className="w-20 h-20 border-4 border-white shadow-md">
                <AvatarImage src="/african-woman-profile.png" />
                <AvatarFallback className="bg-[#F4A261] text-white text-2xl font-semibold">
            ...
            <div className="flex-1">
              <h2 className="text-xl font-bold text-gray-900 font-sans">{user?.name || "Marie Nguema"}</h2>
              <p className="text-gray-500 text-sm">{user?.phone || "+237 6 90 12 34 56"}</p>
              <p className="text-gray-500 text-sm">{user?.email || "marie.nguema@email.com"}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 mt-6 pt-6 border-t">
            <div className="text-center">
              <p className="text-2xl font-bold text-[#2D6A4F]">3</p>
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-1">
                ...
                <span className="text-2xl font-bold text-[#2D6A4F]">4.8</span>
              </div>
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            ...
            <Badge className="bg-[#2D6A4F]/10 text-[#2D6A4F] rounded-full px-3 py-1">100% Ponctuel</Badge>
            <Badge className="bg-[#F4A261]/20 text-[#D2691E] rounded-full px-3 py-1">Ancien Trésorier</Badge>
          </div>
        </Card>
      </div>
